			...
			<div class="row">
				...
				<div class="product-input">
					...
					<form id="product-input-form" name="product-input-form" enctype="multipart/form-data">
						<input id="name" name="name" type="text" placeholder="Display Name" value="<?php echo $product->name; ?>" required>
						<textarea id="description" name="description"  placeholder="Product Descriptions" rows="10"><?php echo $product->description; ?></textarea>
						<div>
						...
						<div class="price-input">
							<span>Rp</span>
							<input id="price" name="price" type="text" min="0" class="text-align-right" value="<?php echo $product->price; ?>"placeholder="Price"required>
						</div>
						<div>
